...
if tab == 'Train a Model':
    if dataset is None:
        st.header('Use Case: Spotify Recommendations 🎵')
        st.page_link('https://www.kaggle.com/datasets/bricevergnou/spotify-recommendation/data', label = 'Click here to view the dataset', icon = '📊')
